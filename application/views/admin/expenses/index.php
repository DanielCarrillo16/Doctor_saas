      ...
      <div class="box-body">
        <form id="cat-form" method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/services/add')?>" role="form" novalidate>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" required name="concept" value="<?php echo html_escape($expense[0]['concept']); ?>" >
          </div>
                  ...
                  <?php $i=1; foreach ($expenses as $expense): ?>
                    <tr id="row_<?php echo html_escape($expense->id); ?>">
                        ...
                        <?php if (is_admin() || is_user() && user()->id == $expense->user_id): ?>
                          ...
                          <a href="<?php echo base_url('admin/department/edit/'.html_escape($expense->id));?>" class="on-default edit-row" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> &nbsp; 

                          <a data-val="page" data-id="<?php echo html_escape($expense->id); ?>" href="<?php echo base_url('admin/department/delete/'.html_escape($row->id));?>" class="on-default remove-row delete_item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-o"></i></a>
